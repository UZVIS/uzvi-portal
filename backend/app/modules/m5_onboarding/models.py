...
class OnboardingInstance(Base):
    ...
    employee_id = Column(String, ForeignKey("employees.employee_id"), unique=True, nullable=False)
    ...
    tasks = relationship("OnboardingTaskCompletion", back_populates="instance", cascade="all, delete-orphan")
...
class OnboardingTaskCompletion(Base):
    ...
    instance_id = Column(String, ForeignKey("onboarding_instances.instance_id"), nullable=False)
